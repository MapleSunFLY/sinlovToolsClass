...
//                	tempNumber=tempNumber2.divideToIntegralValue(tempNumber2, this.mc);
                	tempNumber = BigDecimal.valueOf(tempNumber2.doubleValue() % tempNumber1.doubleValue());
                	BigDecimal zeroBigDecimal = new BigDecimal("0");
                	if ( tempNumber.precision() > this.mc.getPrecision() && !tempNumber.equals(zeroBigDecimal)) {
						tempNumber.round(mc);
					}else if(!tempNumber.equals(zeroBigDecimal)){
						int tempLenth = tempNumber.precision();
						String tempString = null;
						for (int j = 0; j < this.mc.getPrecision() - tempLenth; j++) {
							tempString = tempNumber.toString()+"0";
						}
						tempNumber = BigDecimal.valueOf(Double.valueOf(tempString));
					}
//					else {
//						tempNumber1 = zeroBigDecimal;
//					}
                }
...
//    	System.out.println(resultStr);
    	//初始化对象，传人字符串
//    	MathExpress me = new MathExpress("-(-1.5000000003+54.1)/11+2");
    	MathExpress me1 = new MathExpress("1024/102315151");
//    	MathExpress me1 = new MathExpress("00+1+2");
    	String meString = me1.caculate();
    	BigDecimal mebig = new BigDecimal(meString);
    	BigDecimal mebig2 = mebig.setScale(5,RoundingMode.HALF_UP);
    	System.out.println(mebig2);
    	//普通模式计算，输出计算结果
//    	String resultStr = me.caculate();
//    	System.out.println(me.caculate());
    	System.out.println(me1.caculate());
    	
//    	//精度模式计算，输出结果
//    	BigDecimal bd = new BigDecimal(resultStr);
//    	BigDecimal bd2 = bd.setScale(2, RoundingMode.HALF_UP);
//    	System.out.println("me: "+me.caculate());
